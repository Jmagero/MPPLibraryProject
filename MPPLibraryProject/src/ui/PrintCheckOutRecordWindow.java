...
public class PrintCheckOutRecordWindow extends JFrame implements SystemWindow {

	private static final long serialVersionUID = 1L;
	public static final PrintCheckOutRecordWindow UI = new PrintCheckOutRecordWindow();
